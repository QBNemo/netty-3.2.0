...
public class Channels {
    protected static Logger log = LoggerFactory.getLogger(Channels.class);
    ...
    public static void fireChannelOpen(Channel channel) {
        ...
        // 先父后子
        log.debug("interestOps: 0x" + Integer.toHexString(channel.getInterestOps()) + ", channel: " + channel.toString());
    ...
    public static void fireWriteComplete(Channel channel, long amount) {
        log.debug("interestOps: 0x" + Integer.toHexString(channel.getInterestOps()) + ", channel: " + channel.toString() + ", amount: " + amount);
        if (amount == 0) {
            return;
        }
    ...
    public static void fireWriteComplete(ChannelHandlerContext ctx, long amount) {
        log.debug("interestOps: 0x" + Integer.toHexString(ctx.getChannel().getInterestOps()) + ", context: " + ctx.toString() + ", amount: " + amount);
    ...
    public static void fireExceptionCaught(Channel channel, Throwable cause) {
        log.debug("interestOps: 0x" + Integer.toHexString(channel.getInterestOps()) + ", channel: " + channel.toString() + ", cause: " + cause.getMessage());
        channel.getPipeline().sendUpstream(
    ...
    public static void fireExceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
        log.debug("interestOps: 0x" + Integer.toHexString(ctx.getChannel().getInterestOps()) + ", context: " + ctx.toString() + ", cause: " + cause.getMessage());
    ...
    private static void fireChildChannelStateChanged(
        ...
        log.debug("interestOps: 0x" + Integer.toHexString(channel.getInterestOps()) + ", interestOpsChild: 0x" + Integer.toHexString(childChannel.getInterestOps()));
        channel.getPipeline().sendUpstream(
